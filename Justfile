...
build:
    ...
    {{python}} scripts/check-release-zeroize.py target/wasm32-unknown-unknown/release/sigil_plugin_mysql.wasm
    ...
    {{wasm_tools}} component targets wit --world sigil:mysql/mysql@0.2.0 plugin.wasm
